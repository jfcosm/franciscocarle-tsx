...
interface FooterProps {
  // Although not passed in previous App.tsx, we need it now. 
  // I will assume App.tsx passes it or I can just use a default/context. 
  // To keep changes minimal I'll update App.tsx to pass lang here? 
  // Wait, I can just grab it from props if I update App.tsx
}

// Update component definition to accept lang
const Footer: React.FC<{ lang?: LanguageCode }> = ({ lang = 'es' }) => {
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-16">
          <a 
            ...
            className="flex items-center gap-3 px-6 py-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-primary-500 transition-colors group w-full md:w-auto shadow-sm"
          >
            <div className="p-2 bg-slate-100 dark:bg-slate-800 rounded-lg group-hover:bg-primary-500/20 transition-colors">
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="flex items-center gap-3 px-6 py-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-blue-500 transition-colors group w-full md:w-auto shadow-sm"
          >
          ...
          <div className="flex items-center gap-3 px-6 py-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 w-full md:w-auto shadow-sm">
