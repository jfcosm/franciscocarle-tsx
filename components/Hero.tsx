    ...
    <section id="hero" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 animate-fade-in-up" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-xs font-medium text-slate-600 dark:text-slate-300 backdrop-blur-sm">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <a 
              href="#projects" 
              className="px-8 py-3 rounded-full bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 font-bold hover:bg-slate-800 dark:hover:bg-white transition-transform hover:scale-105 flex items-center gap-2"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noreferrer" 
              className="px-8 py-3 rounded-full border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors backdrop-blur-sm"
            >
              {t.cta_linkedin}
            </a>
          </div>
          ...
          <div className="flex gap-6 pt-8 border-t border-slate-200 dark:border-slate-800/50">
            <div className="text-center md:text-left">
              ...
              <p className="text-sm text-slate-500 uppercase tracking-wider">{t.years_exp}</p>
            </div>
            <div className="text-center md:text-left">
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white">2</h3>
              <p className="text-sm text-slate-500 uppercase tracking-wider">{t.albums}</p>
            </div>
            <div className="text-center md:text-left">
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white">6+</h3>
              <p className="text-sm text-slate-500 uppercase tracking-wider">{t.teams}</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative flex justify-center md:justify-end">
          <div className="relative w-80 h-80 md:w-96 md:h-96">
            ...
            {/* Floating Badges */}
            <div className="absolute -left-4 top-20 bg-white/90 dark:bg-slate-900/90 backdrop-blur border border-slate-200 dark:border-slate-700 p-3 rounded-xl shadow-lg flex items-center gap-3 animate-bounce-slow">
            ...
            <div className="absolute -right-4 bottom-20 bg-white/90 dark:bg-slate-900/90 backdrop-blur border border-slate-200 dark:border-slate-700 p-3 rounded-xl shadow-lg flex items-center gap-3 animate-bounce-slow delay-1000">
